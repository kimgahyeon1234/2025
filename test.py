...
scenarios = {
    "🚗 교통사고": [
        ...
        },
        {
            ...
            "options": ["사고 위치", "환자 혈액형", "보험사 정보"],
            "answer": "사고 위치",
            "explanation": "정확한 위치가 구조 도착 시간을 좌우합니다.",
        },
        {
            "question": "출혈이 심한 환자에게 가장 먼저 시행할 처치는?",
            "options": ["상처 소독", "압박 지혈", "환자에게 물 마시게 하기"],
            "answer": "압박 지혈",
            "explanation": "깨끗한 천/거즈로 직접 압박하여 출혈을 우선 멈춥니다.",
        },
        {
            "question": "척추 손상이 의심되는 환자에게 적절한 대처는?",
            "options": ["자세를 자주 바꿔준다", "절대 움직이지 않게 고정", "목만 들어 호흡을 편하게 한다"],
            "answer": "절대 움직이지 않게 고정",
            "explanation": "불필요한 움직임은 신경 손상을 악화시킬 수 있습니다.",
        },
        {
            "question": "차량에서 연기가 나기 시작했다. 가장 적절한 행동은?",
            "options": ["소화기 꺼내 불을 직접 끈다", "즉시 차량 밖 안전지대로 대피", "보닛을 열어 확인"],
            "answer": "즉시 차량 밖 안전지대로 대피",
            "explanation": "연기와 유독가스는 빠르게 위험을 높입니다. 대피가 우선입니다.",
        },
        {
            "question": "다수사상 사고에서 우선순위 분류 기준에 가장 부합하는 대상은?",
            "options": ["경미한 찰과상 환자", "의식/호흡 없음 환자", "걷는 것이 가능한 환자"],
            "answer": "의식/호흡 없음 환자",
            "explanation": "생명 위급도가 가장 높은 환자에게 우선 처치와 지원이 필요합니다.",
        },
    ],

    "🔥 화상": [
        {
            "question": "열에 의한 경미~중등도 화상 초기에 가장 먼저 할 일은?",
            "options": ["연고 도포", "흐르는 찬물로 10분 이상 냉각", "얼음 직접 적용"],
            "answer": "흐르는 찬물로 10분 이상 냉각",
            "explanation": "냉각으로 조직 손상을 줄입니다. 얼음은 동상 위험이 있어 금지.",
        },
        {
            "question": "물집(blister)이 생겼다. 올바른 처치는?",
            "options": ["멸균 바늘로 살짝 터뜨린다", "그대로 두고 보호한다", "소독약을 붓는다"],
            "answer": "그대로 두고 보호한다",
